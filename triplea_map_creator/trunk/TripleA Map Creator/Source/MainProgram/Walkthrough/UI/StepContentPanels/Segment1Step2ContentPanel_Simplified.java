 ...
 * @author Stephen
 */
public class Segment1Step2ContentPanel_Simplified extends BaseStepContentPanel {

    private BufferedImage m_image = null;
    private Graphics2D m_graphics = null;
    private int m_toolType = 0;
    /** Creates new form Segment1Step1ContentPanel */
    public Segment1Step2ContentPanel_Simplified()
    {
        initComponents();
        //InitKeyListeners();
    }
    ...
    private void initComponents() {
        ...
        v_landButton = new javax.swing.JButton();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(Segment1Step2ContentPanel_Simplified.class);
        ...
        v_toolbarPanel.add(v_toolSizeSlider, new org.netbeans.lib.awtextra.AbsoluteConstraints(378, 5, 50, 50));

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(Segment1Step2ContentPanel_Simplified.class, this);
        ...
        v_fillButton.setNextFocusableComponent(v_landButton);
        v_toolbarPanel.add(v_fillButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 3, 55, 26));
        ...
        v_landButton.setAction(actionMap.get("LandClicked")); // NOI18N
        v_landButton.setFont(resourceMap.getFont("v_undoButton.font")); // NOI18N
        v_landButton.setText(resourceMap.getString("v_landButton.text")); // NOI18N
        v_landButton.setToolTipText(resourceMap.getString("v_landButton.toolTipText")); // NOI18N
        v_landButton.setMargin(new java.awt.Insets(0, 0, 0, 0));
        v_landButton.setName("v_landButton"); // NOI18N
        v_landButton.setNextFocusableComponent(v_eraseButton);
        v_toolbarPanel.add(v_landButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 32, 55, 26));
    ...
    {//GEN-HEADEREND:event_drawingMouseReleased
        ...
        if (m_origScrollPoint == null)
        {
            ...
            if (m_toolType == 1 && evt.getX() < m_image.getWidth() && evt.getY() < m_image.getHeight())
            {
                Runnable runner = new Runnable()
                {
                    public void run()
                    {
                        ...
                        int hy = 0;
                        m_oldImage = ClonedImage(m_image);
                        if (m_image.getRGB(mEvt.getPoint().x, mEvt.getPoint().y) == Constants.DefaultWaterColor.getRGB())
                        {
                            return;
                        }
                        ...
                        for (Point p : pixels)
                        {
                            ...
                            m_image.setRGB(p.x, p.y, Constants.DefaultWaterColor.getRGB());
                        }
                        bounds.x = lx;
                        bounds.y = ly;
            ...
            else if (m_toolType == 4 && evt.getX() < m_image.getWidth() && evt.getY() < m_image.getHeight())
            {
                Runnable runner = new Runnable()
                {
                    public void run()
                    {
                        ...
                        int hy = 0;
                        m_oldImage = ClonedImage(m_image);
                        if (m_image.getRGB(mEvt.getPoint().x, mEvt.getPoint().y) == Color.white.getRGB())
                        {
                            return;
                        }
                        ArrayList<Point> pixels = FindConnectedPixels(m_image, mEvt.getPoint());
                        for (Point p : pixels)
                        {
                            ...
                            m_image.setRGB(p.x, p.y, Color.white.getRGB());
                        }
                        bounds.x = lx;
                        bounds.y = ly;
                        bounds.width = hx - lx + 1;
    ...
    public void PenClicked()
    {
        ...
        v_landButton.setBackground(Constants.DefaultButtonBackColor);
    }
    ...
    {
        m_toolType = 4;
        v_landButton.setBackground(Constants.SelectedButtonBackColor);
    ...
    private javax.swing.JButton v_landButton;
